...
const Hero = () => (
  <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
    ...
    >
      {/* <img src={robot} alt="" /> */}
      <div className="flex flex-rpw items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2">
        <img src={discount} alt="dicount" className="w-[32px] h-[32px]" />
        <p className={`ml-2 text-transform:uppercase ${styles.paragraph}`}>
      ...
      <div className=" flex flex-row justify-between items-center w-full">
        ...
        <div className="text-white ss:flex hidden md:mr-4">
          <GetStarted />
        </div>
      </div>
